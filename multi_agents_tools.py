...
# def create_agent_cifar(hidden_size: int = 256, num_classes: int = 10, input_shape: tuple = (32,32,3)):
#     """
#     Agent CNN pour CIFAR-10 (ou autres images 32x32 RGB) capable d'atteindre
#     de bonnes performances avec vote majoritaire multi-agent.
    
#     Architecture :
#     - Conv2D x2 → MaxPooling
#     - Conv2D x2 → MaxPooling
#     - Flatten → Dense cachée → Dense logits → Softmax
#     """
#     if input_shape is None:
#         input_shape = (32, 32, 3)  # CIFAR-10 par défaut
#     layers = [
...
#         tf.keras.layers.Dense(hidden_size, activation='relu', kernel_initializer='he_normal'),
#         tf.keras.layers.Dense(num_classes, kernel_initializer='glorot_uniform'),
#         tf.keras.layers.Softmax()
#     ]
    
#     model = tf.keras.Sequential(layers, name='agent_cifar')
#     return model
...
# def create_agent_cifar_v2(hidden_size: int = 512, num_classes: int = 10, input_shape: tuple = (32,32,3)):
#     """
#     Agent CNN amélioré pour CIFAR-10.
...
#     model = tf.keras.Sequential(layers, name='agent_cifar_v2')
#     return model
